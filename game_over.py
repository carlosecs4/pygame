...
font_ganhador = pygame.font.Font("fontes/PressStart2P.ttf", 60)
font_aviso = pygame.font.Font("fontes/PressStart2P.ttf", 30)
...
def game_over(tela, ganhador, estado):
    ...
    texto = font_ganhador.render(f'{ganhador}', True, (255, 50, 50))
    texto2 = font_aviso.render('pressione ENTER para recomeçar', True, BRANCO)
